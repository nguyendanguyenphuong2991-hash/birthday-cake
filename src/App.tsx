...
const TYPED_LINES = [
  ...
  "...",
  " mong mọi điều tốt đẹp đến với anh, thương anh thật nhiều"
];
  ...
  return (
    <>
      <group ref={tableGroup}>
        <Table />
        <PictureFrame
          image="/birthday-cake/frame2.jpg"
          position={[0, 0.735, 3]}
          rotation={[0, 5.6, 0]}
          scale={0.75}
        />
        <PictureFrame
          image="/birthday-cake/frame3.jpg"
          position={[0, 0.735, -3]}
          rotation={[0, 4.0, 0]}
          scale={0.75}
        />
        <PictureFrame
          image="/birthday-cake/frame4.jpg"
          position={[-1.5, 0.735, 2.5]}
          rotation={[0, 5.4, 0]}
          scale={0.75}
        />
        <PictureFrame
          image="/birthday-cake/frame1.jpg"
          position={[-1.5, 0.735, -2.5]}
          rotation={[0, 4.2, 0]}
          scale={0.75}
        />
...
export default function App() {
  ...
  useEffect(() => {
    const audio = new Audio("/birthday-cake/music.mp3");
    audio.loop = true;
    audio.preload = "auto";
    ...
    <div className="App">
      ...
      >
        <Suspense fallback={null}>
          ...
          <Environment
            files={["/birthday-cake/shanghai_bund_4k.hdr"]}
